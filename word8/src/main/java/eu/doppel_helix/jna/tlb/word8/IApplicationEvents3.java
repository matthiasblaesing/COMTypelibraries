...
/**
 * <p>uuid({00020A00-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020A00-0001-0000-C000-000000000046}")
public interface IApplicationEvents3 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1)</p>
     */
