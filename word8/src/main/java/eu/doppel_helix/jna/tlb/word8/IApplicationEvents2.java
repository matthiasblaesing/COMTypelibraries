...
/**
 * <p>uuid({000209FE-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000209FE-0001-0000-C000-000000000046}")
public interface IApplicationEvents2 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1)</p>
     */
