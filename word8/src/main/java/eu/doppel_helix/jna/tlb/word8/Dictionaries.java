...
/**
 * <p>uuid({000209AC-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000209AC-0000-0000-C000-000000000046}")
public interface Dictionaries extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x3e8)</p>
     * <p>vtableId(7)</p>
     */
