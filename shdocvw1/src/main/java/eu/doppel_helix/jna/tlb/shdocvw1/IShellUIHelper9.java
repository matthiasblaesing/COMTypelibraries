 ...
 *
 * <p>uuid({6CDF73B0-7F2F-451F-BC0F-63E0F3284E54})</p>
 */
@ComInterface(iid="{6CDF73B0-7F2F-451F-BC0F-63E0F3284E54}")
public interface IShellUIHelper9 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * @param bstrUrl [in] {@code String}
     */
    @ComMethod(name = "LaunchInHVSI", dispId = 0x63)
    void LaunchInHVSI(String bstrUrl);
            
    /**
     * <p>id(0x67)</p>
     * <p>vtableId(104)</p>
     */
    @ComMethod(name = "GetOSSku", dispId = 0x67)
    Integer GetOSSku();
