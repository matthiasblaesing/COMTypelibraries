 ...
 *
 * <p>uuid({A2A08B09-103D-4D3F-B91C-EA455CA82EFA})</p>
 */
@ComInterface(iid="{A2A08B09-103D-4D3F-B91C-EA455CA82EFA}")
public interface IShellUIHelper5 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1)</p>
     */
