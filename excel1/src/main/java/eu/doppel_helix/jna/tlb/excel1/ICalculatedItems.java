...
/**
 * <p>uuid({00024421-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024421-0001-0000-C000-000000000046}")
public interface ICalculatedItems extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
