...
/**
 * <p>uuid({00020890-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020890-0000-0000-C000-000000000046}")
public interface Label extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
