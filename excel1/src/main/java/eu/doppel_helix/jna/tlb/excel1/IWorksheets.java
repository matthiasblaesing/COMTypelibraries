...
/**
 * <p>uuid({000208B1-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208B1-0001-0000-C000-000000000046}")
public interface IWorksheets extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT FillAcrossSheets(Range Range,
            XlFillWith Type,
            Integer lcid);
