...
/**
 * <p>uuid({00020849-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020849-0000-0000-C000-000000000046}")
public interface ChartTitle extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
