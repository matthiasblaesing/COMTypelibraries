...
/**
 * <p>uuid({000208A9-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A9-0001-0000-C000-000000000046}")
public interface IDrawings extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
