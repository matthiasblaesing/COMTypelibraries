...
/**
 * <p>uuid({00024451-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024451-0001-0000-C000-000000000046}")
public interface IUsedObjects extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
