...
/**
 * <p>uuid({00024430-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024430-0000-0000-C000-000000000046}")
public interface Hyperlinks extends IUnknown, IRawDispatchHandle, IDispatch {
    ...
    com.sun.jna.platform.win32.COM.util.IDispatch Add(com.sun.jna.platform.win32.COM.util.IDispatch Anchor,
            String Address,
            Object SubAddress,
            Object ScreenTip,
    ...
    Hyperlink getItem(Object Index);
    ...
    Hyperlink get_Default(Object Index);
