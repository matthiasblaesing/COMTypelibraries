...
/**
 * <p>uuid({000208A9-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A9-0000-0000-C000-000000000046}")
public interface Drawings extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(75)</p>
     */
    @ComMethod(name = "_Dummy46", dispId = 0x1002e)
    void _Dummy46();
     ...
     * @param Closed [in] {@code Boolean}
     */
    @ComMethod(name = "Add", dispId = 0xb5)
    Drawing Add(Double X1,
            Double Y1,
            Double X2,
            Double Y2,
            Boolean Closed);
