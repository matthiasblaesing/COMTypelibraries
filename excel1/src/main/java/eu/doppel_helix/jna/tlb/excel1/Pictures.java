...
/**
 * <p>uuid({000208A7-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A7-0000-0000-C000-000000000046}")
public interface Pictures extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
    ...
    Picture Insert(String Filename,
            Object Converter);
