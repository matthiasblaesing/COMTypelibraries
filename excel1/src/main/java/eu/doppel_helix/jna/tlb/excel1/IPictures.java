...
/**
 * <p>uuid({000208A7-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A7-0001-0000-C000-000000000046}")
public interface IPictures extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Insert(String Filename,
            Object Converter,
            VARIANT RHS);
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Paste(Object Link,
            VARIANT RHS);
