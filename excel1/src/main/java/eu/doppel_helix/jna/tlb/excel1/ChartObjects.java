...
/**
 * <p>uuid({000208D0-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208D0-0000-0000-C000-000000000046}")
public interface ChartObjects extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     */
    ...
    com.sun.jna.platform.win32.COM.util.IDispatch _Default(Object Index);
