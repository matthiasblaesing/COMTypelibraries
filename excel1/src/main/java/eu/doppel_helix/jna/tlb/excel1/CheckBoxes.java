...
/**
 * <p>uuid({00020880-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020880-0000-0000-C000-000000000046}")
public interface CheckBoxes extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
