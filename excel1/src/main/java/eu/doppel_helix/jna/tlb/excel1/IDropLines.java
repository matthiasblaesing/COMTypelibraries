...
/**
 * <p>uuid({000208C4-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208C4-0001-0000-C000-000000000046}")
public interface IDropLines extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
