...
/**
 * <p>uuid({00024443-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024443-0001-0000-C000-000000000046}")
public interface IPublishObjects extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code PublishObject}
     */
    @ComMethod(name = "Add", dispId = 0xb5)
    com.sun.jna.platform.win32.WinNT.HRESULT Add(XlSourceType SourceType,
            String Filename,
            Object Sheet,
            Object Source,
            Object HtmlType,
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Publish();
