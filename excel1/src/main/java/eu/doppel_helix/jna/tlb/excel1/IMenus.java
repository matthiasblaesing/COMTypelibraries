...
/**
 * <p>uuid({00020865-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020865-0001-0000-C000-000000000046}")
public interface IMenus extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
