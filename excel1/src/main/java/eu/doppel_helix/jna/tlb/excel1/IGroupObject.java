...
/**
 * <p>uuid({00020898-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020898-0001-0000-C000-000000000046}")
public interface IGroupObject extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
