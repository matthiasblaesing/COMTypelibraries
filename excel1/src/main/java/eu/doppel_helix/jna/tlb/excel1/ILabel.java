...
/**
 * <p>uuid({00020890-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020890-0001-0000-C000-000000000046}")
public interface ILabel extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
