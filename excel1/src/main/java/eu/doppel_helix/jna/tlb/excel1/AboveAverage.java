...
/**
 * <p>uuid({0002449E-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002449E-0000-0000-C000-000000000046}")
public interface AboveAverage extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>id(0xaab)</p>
     * <p>vtableId(16)</p>
     * @param param0 [in] {@code XlAboveBelow}
     */
    @ComProperty(name = "AboveBelow", dispId = 0xaab)
    void setAboveBelow(XlAboveBelow param0);
     ...
     */
    @ComProperty(name = "NumStdDev", dispId = 0xaac)
    void setNumStdDev(Integer param0);
