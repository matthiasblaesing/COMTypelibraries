...
/**
 * <p>uuid({000208D0-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208D0-0001-0000-C000-000000000046}")
public interface IChartObjects extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT _Copy(VARIANT RHS);
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT getProtectChartObject(VARIANT RHS);
     ...
     */
    @ComProperty(name = "ProtectChartObject", dispId = 0x5f9)
    com.sun.jna.platform.win32.WinNT.HRESULT setProtectChartObject(Boolean RHS);
     ...
     * @param RHS [out] {@code ChartObject}
     */
