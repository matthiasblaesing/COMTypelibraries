...
/**
 * <p>uuid({0002088D-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002088D-0001-0000-C000-000000000046}")
public interface ISpinner extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
