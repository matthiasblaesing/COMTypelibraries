...
public interface ShadowFormat extends IUnknown, IRawDispatchHandle, IDispatch {
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getForeColor();
            
    /**
     * <p>id(0x64)</p>
     * <p>vtableId(13)</p>
     * @param param0 [in] {@code eu.doppel_helix.jna.tlb.office2.ShadowFormat}
     */
    @ComProperty(name = "ForeColor", dispId = 0x64)
    void setForeColor(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getObscured();
     ...
     */
    @ComProperty(name = "Obscured", dispId = 0x65)
    void setObscured(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getType();
     ...
     */
    @ComProperty(name = "Type", dispId = 0x69)
    void setType(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getVisible();
     ...
     */
    @ComProperty(name = "Visible", dispId = 0x6a)
    void setVisible(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getStyle();
     ...
     */
    @ComProperty(name = "Style", dispId = 0x6b)
    void setStyle(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.ShadowFormat getRotateWithShape();
     ...
     */
    @ComProperty(name = "RotateWithShape", dispId = 0x6e)
    void setRotateWithShape(eu.doppel_helix.jna.tlb.office2.ShadowFormat param0);
