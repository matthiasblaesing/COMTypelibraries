...
/**
 * <p>uuid({000208CC-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208CC-0000-0000-C000-000000000046}")
public interface ChartArea extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
