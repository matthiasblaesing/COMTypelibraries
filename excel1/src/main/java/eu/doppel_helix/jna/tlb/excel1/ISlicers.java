...
/**
 * <p>uuid({000244C7-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000244C7-0001-0000-C000-000000000046}")
public interface ISlicers extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0xb5)</p>
     * <p>vtableId(14)</p>
     * @param SlicerDestination [in] {@code Object}
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Add(Object SlicerDestination,
            Object Level,
            Object Name,
            Object Caption,
            Object Top,
