...
/**
 * <p>uuid({00024401-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024401-0000-0000-C000-000000000046}")
public interface HPageBreak extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
