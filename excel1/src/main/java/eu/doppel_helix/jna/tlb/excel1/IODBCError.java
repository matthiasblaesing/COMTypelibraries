...
/**
 * <p>uuid({0002442C-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002442C-0001-0000-C000-000000000046}")
public interface IODBCError extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
