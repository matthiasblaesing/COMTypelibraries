...
/**
 * <p>uuid({0002443B-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002443B-0000-0000-C000-000000000046}")
public interface ShapeRange extends IUnknown, IRawDispatchHandle, IDispatch {
    ...
    void Align(eu.doppel_helix.jna.tlb.office2.MsoAlignCmd AlignCmd,
    ...
    void Distribute(eu.doppel_helix.jna.tlb.office2.MsoDistributeCmd DistributeCmd,
            eu.doppel_helix.jna.tlb.office2.MsoTriState RelativeTo);
