...
/**
 * <p>uuid({0002449D-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002449D-0001-0000-C000-000000000046}")
public interface ITop10 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0xaa8)</p>
     * <p>vtableId(15)</p>
     * @param RHS [out] {@code XlTopBottom}
     */
    @ComProperty(name = "TopBottom", dispId = 0xaa8)
    com.sun.jna.platform.win32.WinNT.HRESULT getTopBottom(VARIANT RHS);
            
    /**
     * <p>id(0xaa8)</p>
     * <p>vtableId(16)</p>
     * @param RHS [in] {@code XlTopBottom}
     */
    @ComProperty(name = "TopBottom", dispId = 0xaa8)
    com.sun.jna.platform.win32.WinNT.HRESULT setTopBottom(XlTopBottom RHS);
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT getRank(VARIANT RHS);
     ...
     */
    @ComProperty(name = "Rank", dispId = 0x50a)
    com.sun.jna.platform.win32.WinNT.HRESULT setRank(Integer RHS);
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT getPercent(VARIANT RHS);
     ...
     */
    @ComProperty(name = "Percent", dispId = 0xaa9)
    com.sun.jna.platform.win32.WinNT.HRESULT setPercent(Boolean RHS);
