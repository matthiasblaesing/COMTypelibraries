...
public interface PictureFormat extends IUnknown, IRawDispatchHandle, IDispatch {
    ...
    eu.doppel_helix.jna.tlb.office2.PictureFormat getColorType();
            
    /**
     * <p>id(0x65)</p>
     * <p>vtableId(15)</p>
     * @param param0 [in] {@code eu.doppel_helix.jna.tlb.office2.PictureFormat}
     */
    @ComProperty(name = "ColorType", dispId = 0x65)
    void setColorType(eu.doppel_helix.jna.tlb.office2.PictureFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.PictureFormat getTransparentBackground();
     ...
     */
    @ComProperty(name = "TransparentBackground", dispId = 0x6c)
    void setTransparentBackground(eu.doppel_helix.jna.tlb.office2.PictureFormat param0);
    ...
    eu.doppel_helix.jna.tlb.office2.PictureFormat getCrop();
