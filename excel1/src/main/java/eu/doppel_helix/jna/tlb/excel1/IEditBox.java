...
/**
 * <p>uuid({00020883-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020883-0001-0000-C000-000000000046}")
public interface IEditBox extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
