...
/**
 * <p>uuid({0002089F-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002089F-0001-0000-C000-000000000046}")
public interface IOvals extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
