...
/**
 * <p>uuid({00020882-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020882-0001-0000-C000-000000000046}")
public interface IOptionButtons extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT getGroupBox(VARIANT RHS);
     ...
     * @param RHS [out] {@code OptionButton}
     */
