...
/**
 * <p>uuid({000208A8-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A8-0001-0000-C000-000000000046}")
public interface IDrawing extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code Object}
     */
    @ComMethod(name = "AddVertex", dispId = 0x259)
    com.sun.jna.platform.win32.WinNT.HRESULT AddVertex(Double Left,
            Double Top,
            VARIANT RHS);
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT getVertices(Object Index1,
            Object Index2,
            VARIANT RHS);
