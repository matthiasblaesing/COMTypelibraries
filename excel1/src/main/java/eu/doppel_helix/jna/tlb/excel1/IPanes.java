...
/**
 * <p>uuid({00020894-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020894-0001-0000-C000-000000000046}")
public interface IPanes extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
