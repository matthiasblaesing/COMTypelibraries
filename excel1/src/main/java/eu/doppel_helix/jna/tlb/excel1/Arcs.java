...
/**
 * <p>uuid({000208A1-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000208A1-0000-0000-C000-000000000046}")
public interface Arcs extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     */
