...
/**
 * <p>uuid({000244D6-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000244D6-0001-0000-C000-000000000046}")
public interface IModelTableColumns extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
