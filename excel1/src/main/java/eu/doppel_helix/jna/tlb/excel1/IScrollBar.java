...
/**
 * <p>uuid({00020885-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020885-0001-0000-C000-000000000046}")
public interface IScrollBar extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
