...
/**
 * <p>uuid({00020884-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020884-0001-0000-C000-000000000046}")
public interface IEditBoxes extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code Boolean}
     */
    @ComProperty(name = "PasswordEdit", dispId = 0x48a)
    com.sun.jna.platform.win32.WinNT.HRESULT getPasswordEdit(VARIANT RHS);
     ...
     */
    @ComProperty(name = "PasswordEdit", dispId = 0x48a)
    com.sun.jna.platform.win32.WinNT.HRESULT setPasswordEdit(Boolean RHS);
