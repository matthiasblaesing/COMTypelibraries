...
/**
 * <p>uuid({00024477-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024477-0001-0000-C000-000000000046}")
public interface IXmlNamespaces extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT InstallManifest(String Path,
