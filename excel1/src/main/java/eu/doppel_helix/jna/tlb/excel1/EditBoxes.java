...
/**
 * <p>uuid({00020884-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020884-0000-0000-C000-000000000046}")
public interface EditBoxes extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
     ...
     */
    @ComProperty(name = "PasswordEdit", dispId = 0x48a)
    void setPasswordEdit(Boolean param0);
            
    /**
     * <p>id(0xb5)</p>
     */
    @ComMethod(name = "Add", dispId = 0xb5)
    EditBox Add(Double Left,
            Double Top,
            Double Width,
            Double Height);
