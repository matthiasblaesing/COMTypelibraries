...
/**
 * <p>uuid({00020853-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00020853-0001-0000-C000-000000000046}")
public interface IStyles extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param BasedOn [in, optional] {@code Object}
     * @param RHS [out] {@code Style}
     */
     ...
     * <p>id(0x234)</p>
     * <p>vtableId(13)</p>
     * @param Workbook [in] {@code Object}
     * @param RHS [out] {@code Object}
     */
    @ComMethod(name = "Merge", dispId = 0x234)
    com.sun.jna.platform.win32.WinNT.HRESULT Merge(Object Workbook,
            VARIANT RHS);
