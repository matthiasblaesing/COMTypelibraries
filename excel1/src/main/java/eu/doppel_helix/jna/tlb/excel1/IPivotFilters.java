...
/**
 * <p>uuid({00024484-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024484-0001-0000-C000-000000000046}")
public interface IPivotFilters extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code PivotFilter}
     */
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Add(XlPivotFilterType Type,
            Object DataField,
            Object Value1,
            Object Value2,
            Object Order,
    ...
    com.sun.jna.platform.win32.WinNT.HRESULT Add2(XlPivotFilterType Type,
            Object DataField,
            Object Value1,
            Object Value2,
            Object Order,
