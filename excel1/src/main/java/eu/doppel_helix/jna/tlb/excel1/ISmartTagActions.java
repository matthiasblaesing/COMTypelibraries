...
/**
 * <p>uuid({0002445F-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002445F-0001-0000-C000-000000000046}")
public interface ISmartTagActions extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code SmartTagAction}
     */
