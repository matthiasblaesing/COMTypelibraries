...
/**
 * <p>uuid({000244D2-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000244D2-0000-0000-C000-000000000046}")
public interface WorksheetDataConnection extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
     */
