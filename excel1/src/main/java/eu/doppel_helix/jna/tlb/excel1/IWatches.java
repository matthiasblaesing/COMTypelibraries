...
/**
 * <p>uuid({00024456-0001-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00024456-0001-0000-C000-000000000046}")
public interface IWatches extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     * <p>vtableId(7)</p>
