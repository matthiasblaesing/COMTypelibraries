...
/**
 * <p>uuid({0002087D-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{0002087D-0000-0000-C000-000000000046}")
public interface Button extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x94)</p>
     */
