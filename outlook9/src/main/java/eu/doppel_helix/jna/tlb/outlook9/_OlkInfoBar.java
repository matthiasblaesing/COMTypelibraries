...
/**
 * <p>uuid({000672F6-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000672F6-0000-0000-C000-000000000046}")
public interface _OlkInfoBar extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xfffffdf6)</p>
     */
