...
/**
 * <p>uuid({00063034-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063034-0000-0000-C000-000000000046}")
public interface _MailItem extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(114)</p>
     */
    @ComProperty(name = "VotingOptions", dispId = 0xf01b)
     ...
     */
    @ComProperty(name = "VotingOptions", dispId = 0xf01b)
    void setVotingOptions(String param0);
            
    /**
     * <p>id(0x8524)</p>
     * <p>vtableId(116)</p>
     */
    @ComProperty(name = "VotingResponse", dispId = 0x8524)
     ...
     */
    @ComProperty(name = "VotingResponse", dispId = 0x8524)
    void setVotingResponse(String param0);
     ...
     * <p>vtableId(134)</p>
     */
    @ComProperty(name = "IsIPFax", dispId = 0x859b)
    Boolean getIsIPFax();
     ...
     */
    @ComProperty(name = "IsIPFax", dispId = 0x859b)
    void setIsIPFax(Boolean param0);
     ...
     * <p>vtableId(138)</p>
     */
    @ComProperty(name = "HasCoverSheet", dispId = 0xfab0)
    Boolean getHasCoverSheet();
     ...
     */
    @ComProperty(name = "HasCoverSheet", dispId = 0xfab0)
    void setHasCoverSheet(Boolean param0);
     ...
     * <p>vtableId(169)</p>
     */
    @ComProperty(name = "Sender", dispId = 0xfc7b)
    AddressEntry getSender();
            
    /**
     * <p>id(0xfc7b)</p>
     * <p>vtableId(170)</p>
     * @param param0 [in] {@code AddressEntry}
     */
    @ComProperty(name = "Sender", dispId = 0xfc7b)
    void setSender(AddressEntry param0);
