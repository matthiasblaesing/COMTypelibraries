...
/**
 * <p>uuid({00063097-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063097-0000-0000-C000-000000000046}")
public interface _IconView extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(31)</p>
     */
    @ComProperty(name = "IconViewType", dispId = 0xfb6a)
    OlIconViewType getIconViewType();
            
    /**
     * <p>id(0xfb6a)</p>
     * <p>vtableId(32)</p>
     * @param param0 [in] {@code OlIconViewType}
     */
    @ComProperty(name = "IconViewType", dispId = 0xfb6a)
    void setIconViewType(OlIconViewType param0);
            
    /**
     * <p>id(0xfb6b)</p>
     * <p>vtableId(33)</p>
     */
    @ComProperty(name = "IconPlacement", dispId = 0xfb6b)
    OlIconViewPlacement getIconPlacement();
            
    /**
     * <p>id(0xfb6b)</p>
     * <p>vtableId(34)</p>
     * @param param0 [in] {@code OlIconViewPlacement}
     */
    @ComProperty(name = "IconPlacement", dispId = 0xfb6b)
    void setIconPlacement(OlIconViewPlacement param0);
