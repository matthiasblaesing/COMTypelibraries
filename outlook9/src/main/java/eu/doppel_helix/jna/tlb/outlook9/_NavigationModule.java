...
/**
 * <p>uuid({000630E8-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000630E8-0000-0000-C000-000000000046}")
public interface _NavigationModule extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     */
