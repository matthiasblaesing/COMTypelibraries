...
/**
 * <p>uuid({000672F0-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000672F0-0000-0000-C000-000000000046}")
public interface OlkTimeControlEventsListener {
    /**
     * <p>id(0xfffffda8)</p>
     */
     ...
     * <p>id(0x7d2)</p>
     */
    @ComEventCallback(dispid = 0x7d2)
    void DropButtonClick();
            
    /**
     * <p>id(0x80018200)</p>
     */
    @ComEventCallback(dispid = 0x80018200)
    void AfterUpdate();
            
    /**
     * <p>id(0x80018201)</p>
     */
    @ComEventCallback(dispid = 0x80018201)
