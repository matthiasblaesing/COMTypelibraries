...
public interface ApplicationEvents_11Listener {
    /**
     * <p>id(0xf002)</p>
     */
     ...
     * <p>id(0xfab5)</p>
     */
    @ComEventCallback(dispid = 0xfab5)
    void NewMailEx(String EntryIDCollection);
            
    /**
     * <p>id(0xfb3e)</p>
     */
    @ComEventCallback(dispid = 0xfb3e)
     ...
     * <p>id(0xfb42)</p>
     */
    @ComEventCallback(dispid = 0xfb42)
     ...
     * <p>id(0xfb43)</p>
     */
    @ComEventCallback(dispid = 0xfb43)
     ...
     * <p>id(0xfb44)</p>
     */
    @ComEventCallback(dispid = 0xfb44)
     ...
     * <p>id(0xfb40)</p>
     */
    @ComEventCallback(dispid = 0xfb40)
     ...
     * <p>id(0xfb41)</p>
     */
    @ComEventCallback(dispid = 0xfb41)
