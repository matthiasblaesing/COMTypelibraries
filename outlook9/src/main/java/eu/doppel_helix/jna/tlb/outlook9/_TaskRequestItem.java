...
/**
 * <p>uuid({00063036-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063036-0000-0000-C000-000000000046}")
public interface _TaskRequestItem extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
