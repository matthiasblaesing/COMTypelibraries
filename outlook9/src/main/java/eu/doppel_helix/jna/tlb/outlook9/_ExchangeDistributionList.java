...
/**
 * <p>uuid({000630CA-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000630CA-0000-0000-C000-000000000046}")
public interface _ExchangeDistributionList extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     */
     ...
     * <p>id(0xfaf6)</p>
     */
    @ComMethod(name = "GetExchangeDistributionListMembers", dispId = 0xfaf6)
     ...
     * <p>id(0xfaf7)</p>
     */
    @ComMethod(name = "GetOwners", dispId = 0xfaf7)
