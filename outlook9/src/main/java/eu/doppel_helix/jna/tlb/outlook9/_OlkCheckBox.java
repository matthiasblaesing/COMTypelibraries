...
/**
 * <p>uuid({000672DD-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000672DD-0000-0000-C000-000000000046}")
public interface _OlkCheckBox extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xfffffde1)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(26)</p>
     */
    @ComProperty(name = "TripleState", dispId = 0x2bc)
