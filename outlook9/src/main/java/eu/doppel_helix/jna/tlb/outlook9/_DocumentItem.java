...
/**
 * <p>uuid({00063020-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063020-0000-0000-C000-000000000046}")
public interface _DocumentItem extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     */
