...
/**
 * <p>uuid({00063023-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063023-0000-0000-C000-000000000046}")
public interface _RemoteItem extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(56)</p>
     */
    @ComProperty(name = "HasAttachment", dispId = 0x8f07)
     ...
     * <p>vtableId(57)</p>
     */
    @ComProperty(name = "RemoteMessageClass", dispId = 0x8f02)
     ...
     * <p>vtableId(58)</p>
     */
    @ComProperty(name = "TransferSize", dispId = 0x8f05)
    Integer getTransferSize();
            
    /**
     * <p>id(0x8f04)</p>
     * <p>vtableId(59)</p>
     */
    @ComProperty(name = "TransferTime", dispId = 0x8f04)
    Integer getTransferTime();
