...
/**
 * <p>uuid({000630A2-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000630A2-0000-0000-C000-000000000046}")
public interface _BusinessCardView extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(32)</p>
     */
    @ComProperty(name = "CardSize", dispId = 0xfbda)
    Integer getCardSize();
     ...
     */
    @ComProperty(name = "CardSize", dispId = 0xfbda)
    void setCardSize(Integer param0);
