...
/**
 * <p>uuid({00063039-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{00063039-0000-0000-C000-000000000046}")
public interface _TaskRequestDeclineItem extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xf000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>id(0xf014)</p>
     * <p>vtableId(56)</p>
     * @param AddToTaskList [in] {@code Boolean}
     */
    @ComMethod(name = "GetAssociatedTask", dispId = 0xf014)
    TaskItem GetAssociatedTask(Boolean AddToTaskList);
