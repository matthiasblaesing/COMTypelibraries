...
/**
 * <p>uuid({000672F5-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000672F5-0000-0000-C000-000000000046}")
public interface OlkCategoryEvents extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xfffffda8)</p>
     */
